...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__60.logicBlock_position = function() {
			...
			if (me.__60.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__60.ggCurrentLogicStatePosition == 0) {
					...
					me.__60.style.top='-52%';
				}
				else {
					me.__60.style.left='0px';
					me.__60.style.top='-55%';
				}
			}
		}
		...
		el.ggUpdate = function(filter) {
			if(me.__18a3.ggUpdating == true) return;
			me.__18a3.ggUpdating = true;
			var el=me.__18a3;
			var curNumRows = 0;
			curNumRows = me.__18a3.ggNumRepeat;
			...
			var centerOffsetVert = 0;
				me.__18a3.ggCloneOffsetChanged = false;
			}
			...
			tourNodes = me.__18a3.getFilteredNodes(tourNodes, filter);
			me.__18a3.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__18a3.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__18a3.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__18a3.ggWidth) + 'px';
				parameter.width=me.__18a3.ggWidth + 'px';
				parameter.height=me.__18a3.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__18a3_Class(nodeId, me, el, parameter);
				currentIndex++;
			...
			me.__18a3.ggNodeCount = me.__18a3.ggNumFilterPassed;
			me.__18a3.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__18a3.parentNode && me.__18a3.parentNode.classList.contains('ggskin_subelement') && me.__18a3.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__18a3.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "메인";
		el.ggFilter[1] = "1층";
		...
		me.__18a3.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__18a3.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__18a3.ggCurrentLogicStateSize = newLogicStateSize;
				me.__18a3.style.transition='width 0s, height 0s';
				if (me.__18a3.ggCurrentLogicStateSize == 0) {
					me.__18a3.ggWidth=100;
					me.__18a3.ggHeight=150;
					me.__18a3.ggUpdate();
					skin.updateSize(me.__18a3);
				}
				else {
					me.__18a3.ggWidth=150;
					me.__18a3.ggHeight=180;
					me.__18a3.ggUpdate();
					skin.updateSize(me.__18a3);
				}
			}
		}
		me.__18a3.logicBlock_size();
		me.__18a3.logicBlock_visible = function() {
			...
			if (me.__18a3.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__18a3.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__18a3.style.transition='width 0s, height 0s';
				if (me.__18a3.ggCurrentLogicStateVisible == 0) {
					me.__18a3.style.visibility=(Number(me.__18a3.style.opacity)>0||!me.__18a3.style.opacity)?'inherit':'hidden';
					me.__18a3.ggVisible=true;
				}
				else {
					me.__18a3.style.visibility="hidden";
					me.__18a3.ggVisible=false;
				}
			}
		}
		me.__18a3.logicBlock_visible();
		me.__18a3.ggCurrentLogicStateSize = -1;
		me.__18a3.ggCurrentLogicStateVisible = -1;
		me.__18a3.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__18a3.childNodes.length; i++) {
				var child=me.__18a3.childNodes[i];
		...
		me.__18a.appendChild(me.__18a3);
		...
		el.ggUpdate = function(filter) {
			if(me.__18a1.ggUpdating == true) return;
			me.__18a1.ggUpdating = true;
			var el=me.__18a1;
			var curNumRows = 0;
			curNumRows = me.__18a1.ggNumRepeat;
			if (curNumRows < 1) curNumRows = 1;
			if (typeof filter=='object') {
				el.ggFilter = filter;
			} else {
			...
			var centerOffsetHor = 0;
			var centerOffsetVert = 0;
				me.__18a1.ggCloneOffsetChanged = false;
			}
			el.ggCurrentFilter = filter;
			el.ggInstances = [];
			if (el.hasChildNodes() == true) {
			...
			var currentIndex = 0;
			var keepCloning = true;
			tourNodes = me.__18a1.getFilteredNodes(tourNodes, filter);
			me.__18a1.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__18a1.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__18a1.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__18a1.ggWidth) + 'px';
				parameter.width=me.__18a1.ggWidth + 'px';
				parameter.height=me.__18a1.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__18a1_Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me.__18a1.ggNodeCount = me.__18a1.ggNumFilterPassed;
			me.__18a1.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__18a1.parentNode && me.__18a1.parentNode.classList.contains('ggskin_subelement') && me.__18a1.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__18a1.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "메인";
		el.ggFilter[1] = "2층";
		...
		me.__18a1.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__18a1.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__18a1.ggCurrentLogicStateSize = newLogicStateSize;
				me.__18a1.style.transition='width 0s, height 0s';
				if (me.__18a1.ggCurrentLogicStateSize == 0) {
					me.__18a1.ggWidth=100;
					me.__18a1.ggHeight=150;
					me.__18a1.ggUpdate();
					skin.updateSize(me.__18a1);
				}
				else {
					me.__18a1.ggWidth=150;
					me.__18a1.ggHeight=200;
					me.__18a1.ggUpdate();
					skin.updateSize(me.__18a1);
				}
			}
		}
		me.__18a1.logicBlock_size();
		me.__18a1.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me.__18a1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__18a1.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__18a1.style.transition='width 0s, height 0s';
				if (me.__18a1.ggCurrentLogicStateVisible == 0) {
					me.__18a1.style.visibility=(Number(me.__18a1.style.opacity)>0||!me.__18a1.style.opacity)?'inherit':'hidden';
					me.__18a1.ggVisible=true;
				}
				else {
					me.__18a1.style.visibility="hidden";
					me.__18a1.ggVisible=false;
				}
			}
		}
		me.__18a1.logicBlock_visible();
		me.__18a1.ggCurrentLogicStateSize = -1;
		me.__18a1.ggCurrentLogicStateVisible = -1;
		me.__18a1.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__18a1.childNodes.length; i++) {
				var child=me.__18a1.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
		...
		me.__18a.appendChild(me.__18a1);
		...
		el.ggUpdate = function(filter) {
			...
			for (var i = 0; i < tourNodes.length; i++) {
				...
				parameter.width=me.__59.ggWidth + 'px';
				parameter.height=me.__59.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
		...
		me.__59.logicBlock_size = function() {
			...
			if (me.__59.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me.__59.style.transition='width 0s, height 0s';
				if (me.__59.ggCurrentLogicStateSize == 0) {
					me.__59.ggWidth=100;
					me.__59.ggHeight=150;
					me.__59.ggUpdate();
					skin.updateSize(me.__59);
				}
				else {
					me.__59.ggWidth=150;
					me.__59.ggHeight=200;
					me.__59.ggUpdate();
					skin.updateSize(me.__59);
				}
			}
		...
		me.__59.ggCurrentLogicStateSize = -1;
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me._rectangle_40.appendChild(me.__18);
		me.__16.appendChild(me._rectangle_40);
		...
		me.__16.appendChild(me._map_31);
		...
		me.__15.logicBlock_text = function() {
			...
			if (me.__15.ggCurrentLogicStateText != newLogicStateText) {
				...
				else if (me.__15.ggCurrentLogicStateText == 2) {
					if (me.__15.ggUpdateText) {
					me.__15.ggUpdateText=function() {
						var params = [];
		...
		hs+='left : calc(50% - ((100% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((77.57% + 0px) / 2) + 0px);';
		hs+='visibility : inherit;';
		hs+='width : 100%;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
		...
		player.addListener('changenode', function(event) {
			...
			me.__58.logicBlock_position();
			me.__18a3.logicBlock_visible();
			me.__18a3.ggUpdateConditionNodeChange();
			me.__18a1.logicBlock_visible();
			me.__18a1.ggUpdateConditionNodeChange();
			me.__59.logicBlock_visible();
		...
		player.addListener('sizechanged', function(event) {
			for(var i = 0; i < me.__59.ggInstances.length; i++) {
				me.__59.ggInstances[i].ggEvent_sizechanged(event);
			}
			for(var i = 0; i < me.__18a1.ggInstances.length; i++) {
				me.__18a1.ggInstances[i].ggEvent_sizechanged(event);
			}
			for(var i = 0; i < me.__18a3.ggInstances.length; i++) {
				me.__18a3.ggInstances[i].ggEvent_sizechanged(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
	...
	function SkinCloner__18a1_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		me._rectangle_118a0.appendChild(me.__18a2);
	...
	function SkinCloner__18a3_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		els=me.__18a4__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__18a4.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.ggUserdata.title)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
		...
		me._rectangle_118a1.appendChild(me.__18a4);
